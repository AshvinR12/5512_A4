...
ld <- cleaned_data%>% filter(postcode %in% c(3012,3021,
                                            3032,3038,
                                            3041,3046,
                                            3047,3055,
                                            3060,3064))
...
```{r growth-rate, fig.cap= "Growth Rate of Covid cases within the lockdown period of 30th June to 29th July 2020"}
